...
@implementation AlexSafeThreadDictionary {
...
- (BOOL)isEqualToDictionary:(NSDictionary *)otherDictionary {
    ...
    if ([otherDictionary isKindOfClass:AlexSafeThreadDictionary.class]) {
        AlexSafeThreadDictionary *other = (id)otherDictionary;
        BOOL isEqual;
...
- (BOOL)isEqual:(id)object {
    ...
    if ([object isKindOfClass:AlexSafeThreadDictionary.class]) {
        AlexSafeThreadDictionary *other = object;
        BOOL isEqual;
        pthread_mutex_lock(&_mutex_lock);
        pthread_mutex_lock(&(other->_mutex_lock));
        isEqual = [_dic isEqual:other->_dic];
